...
public class TaiXe_DangKy_4Activity extends AppCompatActivity {
    Button BSelectImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tai_xe_dang_ky4);
    ...
    public void tiepTuc(View view) {
        if(uri == null){
            Toast.makeText(TaiXe_DangKy_4Activity.this, "Chưa chọn hình", Toast.LENGTH_SHORT).show();
        }
        else{
            ...
            Call<APIResponse> call = apiInterface.addHinhXe(multipartbodyimageFile,requestBodytaiKhoan);
            call.enqueue(new Callback<APIResponse>() {
                @Override
                public void onResponse(Call<APIResponse> call, Response<APIResponse> response) {
                    int statuscode = response.code();
                    if(statuscode == 200){
                        Toast.makeText(TaiXe_DangKy_4Activity.this, "Đã lưu", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(TaiXe_DangKy_4Activity.this,TaiXe_DangKy_5Activity.class);
                        intent.putExtra("taiKhoan",taiKhoan);
                        startActivity(intent);
                    }
                    else{
                        Toast.makeText(TaiXe_DangKy_4Activity.this, "Lỗi " + statuscode, Toast.LENGTH_SHORT).show();
                    }
                }
