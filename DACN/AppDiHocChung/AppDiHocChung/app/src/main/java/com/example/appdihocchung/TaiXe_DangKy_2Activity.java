...
public class TaiXe_DangKy_2Activity extends AppCompatActivity {
    Button BSelectImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tai_xe_dang_ky2);
    ...
    public void tiepTuc(View view) {
        if(uri == null){
            Toast.makeText(TaiXe_DangKy_2Activity.this, "Chưa chọn hình", Toast.LENGTH_SHORT).show();
        }
        else{
            ...
            Call<APIResponse> call = apiInterface.addBangLai(multipartbodyimageFile,requestBodytaiKhoan);
            call.enqueue(new Callback<APIResponse>() {
                @Override
                public void onResponse(Call<APIResponse> call, Response<APIResponse> response) {
                    int statuscode = response.code();
                    if(statuscode == 200){
                        Toast.makeText(TaiXe_DangKy_2Activity.this, "Đã lưu", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(TaiXe_DangKy_2Activity.this,TaiXe_DangKy_3Activity.class);
                        intent.putExtra("taiKhoan",taiKhoan);
                        startActivity(intent);
                    }
                    else{
                        Toast.makeText(TaiXe_DangKy_2Activity.this, "Lỗi " + statuscode, Toast.LENGTH_SHORT).show();
                    }
                }
